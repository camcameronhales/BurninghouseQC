...
class TestBlackClassification:
    ...
    def test_black_at_head_is_only_review(self):
        """A fade up from black is normal and must not fail the file."""
    ...
    def test_black_at_tail_is_only_review(self):
...
class TestSilenceClassification:
    ...
    def test_head_silence_is_review(self):
